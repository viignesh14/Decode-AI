// ============================================================
// Decode AI — Backend Proxy Server
// Chrome Extension → THIS SERVER → Gemini API
//
...
// CORS — allow Chrome extension origins (chrome-extension://)
app.use(cors({
...
app.listen(PORT, '0.0.0.0', () => {
    console.log(`\n🚀 Decode AI Backend running on http://0.0.0.0:${PORT}`);
    console.log(`   Health check: http://localhost:${PORT}/health`);
    console.log(`   Generate:     POST http://localhost:${PORT}/generate`);
    console.log(`\n🔐 API key loaded: ${process.env.GEMINI_API_KEY ? '✅ Yes' : '❌ NOT FOUND — check .env'}`);
